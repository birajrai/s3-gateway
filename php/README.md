...
[![GitHub](https://img.shields.io/badge/GitHub-birajrai/php--s3-server-blue.svg)](https://github.com/birajrai/php-s3-server)
...
| Type | Path |
|------|------|
| Objects | `{DATA_DIR}/{bucket}/{key}` |
| Multipart Parts | `{DATA_DIR}/{bucket}/.multipart/{uploadId}/{partNumber}` |
